...
parser.add_argument('--start_epoch', type=int, default=150, metavar='N', help='number of start epoch (default: 1)')
...
def main():
    ...
    nsml.load(checkpoint = 'Res18baseMM_e149', session = 'kaist_15/fashion_eval/405')
    if opts.mode == 'train':
        model.train()
        # Set dataloader
