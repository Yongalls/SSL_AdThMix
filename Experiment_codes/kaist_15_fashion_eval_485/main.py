...
parser.add_argument('--start_epoch', type=int, default=300, metavar='N', help='number of start epoch (default: 1)')
...
def main():
    ...
    if opts.mode == 'train':
        model.train()
        # Set dataloader
        nsml.load(checkpoint = 'Res18baseMM_e299', session = 'kaist_15/fashion_eval/477')
