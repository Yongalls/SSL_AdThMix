...
class SimpleImageLoader(torch.utils.data.Dataset):
    def __init__(self, rootdir, split, ids=None, ra=None, transform=None, loader=default_image_loader):
        if split == 'test':
        ...
        self.TransformTwice_w = TransformTwice(self.transform_w)
    ...
    def __getitem__(self, index):
        ...
        if self.split == 'test':
            ...
            imgw1, imgw2 = self.TransformTwice_w(img)
            return img1, img2, imgw1, imgw2
